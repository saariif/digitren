...
use App\Http\Controllers\Nadhoman\NadhomanController;
...
use App\Http\Controllers\Tahfidz\TahfidzController;
...
use App\Http\Controllers\TahunAjar\TahunAjarController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group(['middleware' => ['role:Administrator|Pengurus']], function () {
        ...
        // tahfidz
        Route::controller(TahfidzController::class)->as('tahfidz.')->group(function () {
            Route::get('/tahfidz', 'index')->name('index');
            Route::get('/tahfidz/{id}', 'show')->name('show');
            Route::post('/tahfidz', 'store')->name('store');
            Route::patch('/tahfidz/update/{tahfidz}', 'update')->name('update');
            Route::delete('/tahfidz/destroy/{tahfidz}', 'destroy')->name('destroy');
        });
        // Nadhoman
        Route::controller(NadhomanController::class)->as('nadhoman.')->group(function () {
            Route::get('/nadhoman', 'index')->name('index');
            Route::get('/nadhoman/{id}', 'show')->name('show');
            Route::post('/nadhoman', 'store')->name('store');
            Route::patch('/nadhoman/update/{nadhoman}', 'update')->name('update');
            Route::delete('/nadhoman/destroy/{nadhoman}', 'destroy')->name('destroy');
        });
        ...
        // AKADEMIK
        // Tahun Ajar
        Route::controller(TahunAjarController::class)->as('tahun_ajar.')->group(function () {
            Route::get('/tahun_ajar', 'index')->name('index');
            Route::get('/tahun_ajar/{id}', 'show')->name('show');
            Route::post('/tahun_ajar', 'store')->name('store');
            Route::patch('/tahun_ajar/update/{tahun_ajar}', 'update')->name('update');
            Route::delete('/tahun_ajar/destroy/{tahun_ajar}', 'destroy')->name('destroy');
        });
