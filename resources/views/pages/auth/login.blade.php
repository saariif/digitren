                    ...
                    <div class="card radius-15 overflow-hidden">
                        <div class="row g-0">
                            <div class="col-xl-6 col-md-6">
                                <div class="card-body p-5">
                                    <div class="text-center">
                                        <img src="{{ url('assets/images/logo-icon-putih.png') }}" width="80" alt="">
                                        <h6 class="mt-4 font-weight-bold">Islamic Boarding School</h6>
                                        <h5 class="mt-0 font-weight-bold">Padepokan Kyai Mudrikah Kembang Kuning</h5>
                                    </div>
                                    <div class="mt-4">
                                        <div class="form-body">
                            ...
                            <div class="col-xl-6 col-md-6 bg-login-color d-flex align-items-center justify-content-center">
                                <img src="{{ url('assets/images/login-images/register-frent-img.jpg') }}" class="img-fluid"
                                    alt="image">
                            </div>
                        </div>
                        <!--end row-->
